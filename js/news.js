...
async function fetchNews() {
    try {
        // ดึงข้อมูลจาก API
        const response = await fetch('https://script.google.com/macros/s/AKfycbw8wPGuajTnFlvV1E_004MPUFp11GBPECzc7tIgSa7icPt1X5k9-MDtXVpy0LaDy-mLAQ/exec');
                ...
                <div class="single-news-item">
                    ...
                    <div class="info mt-3">
                        <div class="writer mb-3">
                            ...
                            <a href="${link}" class="author d-inline-block">โดย PoohDev</a>
                        </div>
                        <h5>
